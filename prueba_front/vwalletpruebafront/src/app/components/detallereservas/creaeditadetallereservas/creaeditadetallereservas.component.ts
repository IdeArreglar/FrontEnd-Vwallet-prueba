    ...
    if (this.edicion) {
      this.dS.listId(this.id).subscribe((data) => {
        this.form = new FormGroup({
          ...
          reservas_detalle: new FormControl(data.reservas.idReservas),
          menu_detalle: new FormControl(data.menu.idMenu),
          transporte_detalle: new FormControl(data.transporte.idTransporte),
          libro_detalle: new FormControl(data.libro.idLibro),
        });
      });
    }
  }
